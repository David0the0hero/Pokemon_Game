...
#cursor.execute("CREATE TABLE users (username VARCHAR(255),pasword VARCHAR(255),pokemon VARCHAR(255));")

ask_acc = input("do you have an account? (y/n)->")
if ask_acc == "n":
    ussername = input("enter username->")
    cursor.execute("SELECT usename FROM users;")
...
y = 0
pokedex = {"charizard":Charizard,"pikachu":Pikachu,"springatito":Springatito,"glaceon":Glaceon,"eevee":Eevee,"charmander":Charmander,"charmeleon":Charmeleon,"blastoise":Blastoise,"lucario":Lucario,"riolu":Riolu,"umbreon":Umbreon,"flareon":Flareon,"heracross":Heracross,"pinsir":Pinsir,"squirtle":Squirtle,"gryadoes":Gyrados}
while y == 0: 
    for i in pokedex:
